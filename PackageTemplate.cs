...
namespace CRMPackageDT
{
    ...
    public class PackageTemplate : ImportExtension
    {
        ...
        {
            if (plural)
                return "Armen packages";
            return "Armen package";
        }
        ...
        {
            get { return "Package Description From Armen"; }
        }
        ...
        {
            get { return "Armen Asadyan Package Long Name"; }
        }
